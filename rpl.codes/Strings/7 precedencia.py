...
def precendencia_de_caracteres(cadena, caracter_1, caracter_2):
    pass
Completar el cuerpo de la función. La misma debe retornar la cantidad de veces que el caracter_1 se encuentra inmediatamente antes 
(es decir, en el índice anterior) al caracter_2 en la cadena que se recibe como primer parámetro.
...
def precendencia_de_caracteres(cadena, caracter_1, caracter_2):
    lista = caracter_1 + caracter_2
    contador = 0
    for caracter in range(0, len(cadena)-1):
        if cadena[caracter:caracter+2] == lista:
            contador += 1
    return contador
