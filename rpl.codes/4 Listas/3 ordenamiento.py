...
ordenar_palabras_por_longitud: Recibe una lista que contiene únicamente strings. 
Retorna la lista ordenada en forma descendente (los mas grandes en las primeras posiciones) según la longitud de cada string.

Ejemplo:

ordenar_palabras_por_longitud(["a", "hola", "si", "string largo", "string"]) => ["string largo", "string", "hola", "si", "a"]
ordenar_lista_por_tupla: Recibe una lista de tuplas de longitud 2, cuyos índices contienen únicamente variables numéricas. 
...
ordenar_lista_por_suma_tupla: Recibe una lista de tuplas de longitud 2, cuyos índices contienen únicamente variables numéricas. 
...
#print(ordenar_lista_mayor_menor([5,2,6,23,4]))
...
def ordenar_lista_por_suma_tupla(lista):
    return sorted(lista,key= sum,reverse=True)
#print(ordenar_lista_por_tupla([(1, 5), (7, 3), (5, 4), (4, 3)]))
